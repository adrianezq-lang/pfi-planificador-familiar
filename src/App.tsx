...
function App() {
 ...
 const {menu,planMensual,semanaActiva,seleccionarSemana,mesActivo,cambiarMes,excluirSemana}=useMenu();
 ...
 return <div className="app-shell">
  ...
  <Suspense fallback={<main className="page page-loading"><span>Abriendo…</span></main>}>
   ...
   {pantalla==='menu'&&<Menu menu={menu} planMensual={planMensual} semanaActiva={semanaActiva} seleccionarSemana={seleccionarSemana} mesActivo={mesActivo} cambiarMes={cambiarMes} excluirSemana={excluirSemana}/>} 
